            ...
            <div className="flex flex-col items-center gap-8 w-full max-w-sm z-10 relative">
                ...
                >
                    <div 
                        ...
                        className={`w-full h-full border-2 relative overflow-hidden select-none touch-none group will-change-transform ${isHolding && player.isImp ? 'animate-impostor-shake' : ''}`}
                    >
